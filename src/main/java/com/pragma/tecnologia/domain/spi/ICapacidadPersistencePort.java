...
public interface ICapacidadPersistencePort {
    ...
    Flux<Tecnologia> obtenerTecnologiasPorCapacidad(Long capacidadId);
    Mono<Void> eliminarCapacidad(Long capacidadId);
    Mono<Long> contarUsosEnBootcamps(Long capacidadId);
